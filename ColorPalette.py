...
class ColorPalette:
    ...
    def __init__(self, x: int, y: int, w: int, h: int) -> None:
        ...
        self.image1.fill((128, 128, 128, 255))

        self.image2 = pygame.Surface((w, h//2))
        self.image2.fill((128, 128, 128, 255))
        ...
        for i in range(self.pwidth):
            ...
            pygame.draw.rect(self.image1, color, (i+self.rad, 12, 1, 10))
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        center2 = self.rect2.left + self.rad + self.p2 * self.pwidth, self.rect2.centery
        ...
        pygame.draw.circle(surface, self.get_color(), center3, 10)
